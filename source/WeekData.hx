...
class WeekData {
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: [["Spookeez", "spooky", [146, 113, 253]], ["Fresh", "dad", [146, 113, 253]], ["Dad Battle", "dad", [146, 113, 253]]],
			weekCharacters: ['spooky', 'bf', ''],
			weekBackground: 'halloween',
			weekBefore: 'tutorial',
			storyName: 'Your New Corripted Week',
			weekName: 'Corrupt Week',
			freeplayColor: [0, 0, 0],
			startUnlocked: true,
			hideStoryMode: false,
			hideFreeplay: false,
